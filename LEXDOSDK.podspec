#
#  Be sure to run `pod spec lint LEXDOSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "lex" => "menglingxu@aihelp.net" }
  # Or just: spec.author    = "lex"
  # spec.authors            = { "lex" => "menglingxu@aihelp.net" }
  # spec.social_media_url   = "https://twitter.com/lex"
